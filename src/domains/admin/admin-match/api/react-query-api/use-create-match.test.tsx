...
const createMatchMock = createMatch as Mock;
...
describe("useCreateMatch", () => {
  ...
  it("실패 시 무효화하지 않고 실패 토스트를 띄운다", async () => {
    ...
    expect(toastMock).toHaveBeenCalledWith({ content: "경기 생성에 실패했어요" });
  });
});
