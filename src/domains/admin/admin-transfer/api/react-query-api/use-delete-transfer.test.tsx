...
const deleteTransferMock = deleteTransfer as Mock;
...
describe("useDeleteTransfer", () => {
  ...
  it("실패 시 무효화하지 않고 실패 토스트를 띄운다", async () => {
    ...
    expect(toastMock).toHaveBeenCalledWith({ content: "이적 삭제에 실패했어요" });
  });
});
